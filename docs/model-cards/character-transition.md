# Model Card: Character Transition

Purpose: evidence-bounded target-trial transition for character, agency, and prosocial-behavior outcomes.

Estimand: average treatment effect for an advisor-reviewed intervention prior whose outcome_domain is `character`.
...
Validation status: social or education context features are calibration inputs unless backed by a target-trial prior.
