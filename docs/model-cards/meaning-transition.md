# Model Card: Meaning Transition

Purpose: evidence-bounded target-trial transition for meaning, purpose, and direction outcomes.

Estimand: average treatment effect for an advisor-reviewed intervention prior whose outcome_domain is `meaning`.
...
Validation status: qualitative narratives can contextualize pathways, but cannot validate causal meaning effects.
