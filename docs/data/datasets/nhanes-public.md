# Dataset Card: NHANES Public

Canonical dataset name: `nhanes_public`
...
Codebook mapping: pending approved public table selection

Quality profile: pending public table selection

Provenance manifest: request-status only
