...
Quality profile: Small-cell suppression and disclosure review are required before FDW ingestion. Suppressed rows expose neither deaths nor mortality rates.
...
Access policy: Restricted-use path. Raw mortality records must not enter FDW. Public CDC WONDER outputs use the public CDC path and are clearly separated.
